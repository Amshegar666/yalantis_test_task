...
файл src/config.ts
MAX - максимальное количество пользователей в системе  
MIN - минимальное количество пользователей для запуска перемешивания  
SECRET - код для запуска перемешивания  
